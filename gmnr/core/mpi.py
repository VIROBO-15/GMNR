...
from gmnr.utils.cam_utils import compute_pitch_yaw_from_w2c_mat
...
class MPI(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        flat_render_rgb, flat_render_disp, flat_render_alpha, grid = homography(
            flat_rgbas,
            flat_dhws,
            flat_eye_pos,
            flat_ray_dir,
        ...
        return color_out, depth_out, grid, cat_render_depth, weights
